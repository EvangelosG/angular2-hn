...
This project uses [Vite](https://vitejs.dev/) with React + TypeScript. It requires Node 18+.

 - Clone or download the repo
 - `npm install`
 - `npm run dev` (or `npm start`) to run the application with the Vite dev server (default http://localhost:5173)
...
Note: The service worker is only generated for production builds. To test offline/PWA behaviour locally:
 - `npm run build`
 - `npm run preview` and load the served URL
